<article id="post-<?php echo $content->id; ?>" class="post <?php echo Post::status_name($content->status); ?>" itemscope itemtype="http://schema.org/BlogPosting">
	...
	<header class="metadata">
		...
		<div class="pubdata">
			<?php echo $content->toggle_status_link; ?><span itemprop="author" itemscope itemtype="http://schema.org/Person"><span itemprop="name"><?php echo $content->info->author; ?></span></span>
